...
module riscv_core_dcache_controller #(
    ...
    output logic [                3 : 0]  o_mem_write_strobe
...
always_comb begin : mem_write_strobe_decoder
    o_mem_write_strobe = 4'b0;
   case(i_size)

2'b00:
o_mem_write_strobe = 4'b0001;

2'b01:
o_mem_write_strobe = 4'b0011;

2'b10:
o_mem_write_strobe = 4'b1111;

default:
o_mem_write_strobe = 4'b0000;
